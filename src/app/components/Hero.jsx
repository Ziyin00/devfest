...
const Hero = () => {
  return (
    <div className='bg-black text-white w-screen text-center overflow-hidden'>
      ...
      <div className='flex flex-col justify-center sm:bg-black w-screen items-center '>
        <div className='  z-50'>
      ...
      <p className='sm:mx-[20%] mx-[8%] font-light text-white sm:text-gray-300 z-50 '><span className='font-bold'>More than an event—it's a movement! </span>A place to connect, create, and grow with our tech family. Whether you're starting out or leveling up, this is where innovation meets opportunity!</p>
        </div>
